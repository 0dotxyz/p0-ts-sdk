...
export type Vault = {
   ...
   */
  lastSeenSyExchangeRate: PreciseNumber;
  ...
  finalSyExchangeRate: PreciseNumber;
...
export type VaultArgs = {
   ...
   * This continues to be updated even after vault maturity to track SY appreciation for treasury collection
   */
  lastSeenSyExchangeRate: PreciseNumberArgs;
  /** This is the all time high exchange rate for SY */
  allTimeHighSyExchangeRate: PreciseNumberArgs;
  /** This is the exchange rate for SY when the vault expires */
  finalSyExchangeRate: PreciseNumberArgs;
  /** How much SY is held in escrow */
...
export function getVaultEncoder(): Encoder<VaultArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["lastSeenSyExchangeRate", getPreciseNumberEncoder()],
      ["allTimeHighSyExchangeRate", getPreciseNumberEncoder()],
      ["finalSyExchangeRate", getPreciseNumberEncoder()],
...
export function getVaultDecoder(): Decoder<Vault> {
  return getStructDecoder([
    ...
    ["lastSeenSyExchangeRate", getPreciseNumberDecoder()],
    ["allTimeHighSyExchangeRate", getPreciseNumberDecoder()],
    ["finalSyExchangeRate", getPreciseNumberDecoder()],
