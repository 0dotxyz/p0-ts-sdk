...
export function getLiqPoolEncoder(): FixedSizeEncoder<LiqPoolArgs> {
...
export function getLiqPoolDecoder(): FixedSizeDecoder<LiqPool> {
...
export function getLiqPoolCodec(): FixedSizeCodec<LiqPoolArgs, LiqPool> {
