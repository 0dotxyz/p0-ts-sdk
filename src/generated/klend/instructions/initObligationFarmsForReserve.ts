...
export const INIT_OBLIGATION_FARMS_FOR_RESERVE_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
...
export function getInitObligationFarmsForReserveInstructionDataEncoder(): FixedSizeEncoder<InitObligationFarmsForReserveInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: INIT_OBLIGATION_FARMS_FOR_RESERVE_DISCRIMINATOR })
  );
}
...
export type InitObligationFarmsForReserveInput<
  ...
  TAccountObligationFarm extends InstructionAccountInput = InstructionAccountInput,
...
> = {
  ...
  obligationFarm: TAccountObligationFarm;
...
export function getInitObligationFarmsForReserveInstruction<
  ...
  TAccountObligationFarm extends InstructionAccountInput,
...
>(
  ...
  ResolvedInstructionAccountMeta<
    TAccountObligationFarm,
    InstructionAccountInputAddress<TAccountObligationFarm>
  >,
  ResolvedInstructionAccountMeta<
    TAccountLendingMarket,
...
> {
  ...
  const originalAccounts = {
    ...
    obligationFarm: { value: input.obligationFarm ?? null, isSigner: false, isWritable: true },
...
>(
  ...
  return {
    ...
    data: getInitObligationFarmsForReserveInstructionDataDecoder().decode(instruction.data),
  };
}
