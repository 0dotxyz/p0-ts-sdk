...
export const SET_OBLIGATION_ORDER_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  81, 1, 99, 156, 211, 83, 78, 46,
]);

export function getSetObligationOrderDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(SET_OBLIGATION_ORDER_DISCRIMINATOR);
}
...
export type SetObligationOrderInstructionDataArgs = { index: number; order: ObligationOrderArgs };
...
export function getSetObligationOrderInstructionDataEncoder(): FixedSizeEncoder<SetObligationOrderInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: SET_OBLIGATION_ORDER_DISCRIMINATOR })
  );
}
...
>(
  input: SetObligationOrderInput<TAccountOwner, TAccountObligation, TAccountLendingMarket>,
...
>(
  ...
  return {
    ...
    data: getSetObligationOrderInstructionDataDecoder().decode(instruction.data),
  };
}
