...
export const WITHDRAW_OBLIGATION_COLLATERAL_V2_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
...
export function getWithdrawObligationCollateralV2InstructionDataEncoder(): FixedSizeEncoder<WithdrawObligationCollateralV2InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: WITHDRAW_OBLIGATION_COLLATERAL_V2_DISCRIMINATOR })
  );
}
...
>(
  ...
  return {
    ...
    data: getWithdrawObligationCollateralV2InstructionDataDecoder().decode(instruction.data),
  };
}
