...
export const BORROW_OBLIGATION_LIQUIDITY_V2_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  161, 128, 143, 245, 171, 199, 194, 6,
]);

export function getBorrowObligationLiquidityV2DiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(BORROW_OBLIGATION_LIQUIDITY_V2_DISCRIMINATOR);
}
...
export type BorrowObligationLiquidityV2InstructionDataArgs = { liquidityAmount: number | bigint };
...
export function getBorrowObligationLiquidityV2InstructionDataEncoder(): FixedSizeEncoder<BorrowObligationLiquidityV2InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: BORROW_OBLIGATION_LIQUIDITY_V2_DISCRIMINATOR })
  );
}
...
>(
  ...
  return {
    ...
    data: getBorrowObligationLiquidityV2InstructionDataDecoder().decode(instruction.data),
  };
}
