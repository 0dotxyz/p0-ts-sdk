...
export const BORROW_OBLIGATION_LIQUIDITY_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  121, 127, 18, 204, 73, 245, 225, 65,
]);

export function getBorrowObligationLiquidityDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(BORROW_OBLIGATION_LIQUIDITY_DISCRIMINATOR);
}
...
export type BorrowObligationLiquidityInstructionDataArgs = { liquidityAmount: number | bigint };
...
export function getBorrowObligationLiquidityInstructionDataEncoder(): FixedSizeEncoder<BorrowObligationLiquidityInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: BORROW_OBLIGATION_LIQUIDITY_DISCRIMINATOR })
  );
}
...
>(
  ...
  return {
    ...
    data: getBorrowObligationLiquidityInstructionDataDecoder().decode(instruction.data),
  };
}
