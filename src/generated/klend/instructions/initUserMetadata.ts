...
export const INIT_USER_METADATA_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  117, 169, 176, 69, 197, 23, 15, 162,
]);

export function getInitUserMetadataDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(INIT_USER_METADATA_DISCRIMINATOR);
}
