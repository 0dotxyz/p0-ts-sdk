...
export const REFRESH_OBLIGATION_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  33, 132, 147, 228, 151, 192, 72, 89,
]);

export function getRefreshObligationDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(REFRESH_OBLIGATION_DISCRIMINATOR);
}
...
export type RefreshObligationInstructionData = { discriminator: ReadonlyUint8Array };
