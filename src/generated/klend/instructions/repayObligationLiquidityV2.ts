...
export const REPAY_OBLIGATION_LIQUIDITY_V2_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  116, 174, 213, 76, 180, 53, 210, 144,
]);

export function getRepayObligationLiquidityV2DiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(REPAY_OBLIGATION_LIQUIDITY_V2_DISCRIMINATOR);
}
...
export type RepayObligationLiquidityV2InstructionDataArgs = { liquidityAmount: number | bigint };
...
export function getRepayObligationLiquidityV2InstructionDataEncoder(): FixedSizeEncoder<RepayObligationLiquidityV2InstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: REPAY_OBLIGATION_LIQUIDITY_V2_DISCRIMINATOR })
  );
}
...
>(
  ...
  return {
    ...
    data: getRepayObligationLiquidityV2InstructionDataDecoder().decode(instruction.data),
  };
}
