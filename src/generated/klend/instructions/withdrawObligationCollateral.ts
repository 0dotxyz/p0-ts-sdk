...
export const WITHDRAW_OBLIGATION_COLLATERAL_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  37, 116, 205, 103, 243, 192, 92, 198,
]);

export function getWithdrawObligationCollateralDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(WITHDRAW_OBLIGATION_COLLATERAL_DISCRIMINATOR);
}
...
export type WithdrawObligationCollateralInstructionDataArgs = { collateralAmount: number | bigint };
...
export function getWithdrawObligationCollateralInstructionDataEncoder(): FixedSizeEncoder<WithdrawObligationCollateralInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: WITHDRAW_OBLIGATION_COLLATERAL_DISCRIMINATOR })
  );
}
...
>(
  ...
  return {
    ...
    data: getWithdrawObligationCollateralInstructionDataDecoder().decode(instruction.data),
  };
}
