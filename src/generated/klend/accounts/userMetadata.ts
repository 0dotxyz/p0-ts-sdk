...
export function getUserMetadataDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(USER_METADATA_DISCRIMINATOR);
}
...
export function getUserMetadataCodec(): FixedSizeCodec<UserMetadataArgs, UserMetadata> {
...
export function decodeUserMetadata<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getUserMetadataDecoder());
}
