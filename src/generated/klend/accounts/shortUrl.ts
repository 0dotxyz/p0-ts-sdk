...
export type ShortUrl = { discriminator: ReadonlyUint8Array; referrer: Address; shortUrl: string };
...
export function decodeShortUrl<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getShortUrlDecoder());
}
