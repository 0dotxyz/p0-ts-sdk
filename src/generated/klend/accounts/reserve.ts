...
import {
  ...
  getWithdrawQueueDecoder,
  getWithdrawQueueEncoder,
  type LastUpdate,
  type LastUpdateArgs,
...
export type ReserveArgs = {
  ...
  withdrawQueue: WithdrawQueueArgs;
...
export function getReserveEncoder(): FixedSizeEncoder<ReserveArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["reserveLiquidityPadding", getArrayEncoder(getU64Encoder(), { size: 150 })],
      ["collateral", getReserveCollateralEncoder()],
      ["reserveCollateralPadding", getArrayEncoder(getU64Encoder(), { size: 150 })],
      ["config", getReserveConfigEncoder()],
      ["configPadding", getArrayEncoder(getU64Encoder(), { size: 112 })],
      ...
      ["withdrawQueue", getWithdrawQueueEncoder()],
      ["padding", getArrayEncoder(getU64Encoder(), { size: 204 })],
    ]),
...
export function getReserveDecoder(): FixedSizeDecoder<Reserve> {
  return getStructDecoder([
    ...
    ["reserveLiquidityPadding", getArrayDecoder(getU64Decoder(), { size: 150 })],
    ["collateral", getReserveCollateralDecoder()],
    ["reserveCollateralPadding", getArrayDecoder(getU64Decoder(), { size: 150 })],
    ["config", getReserveConfigDecoder()],
    ["configPadding", getArrayDecoder(getU64Decoder(), { size: 112 })],
    ["borrowedAmountOutsideElevationGroup", getU64Decoder()],
    [
      "borrowedAmountsAgainstThisReserveInElevationGroups",
      getArrayDecoder(getU64Decoder(), { size: 32 }),
    ],
    ["withdrawQueue", getWithdrawQueueDecoder()],
    ["padding", getArrayDecoder(getU64Decoder(), { size: 204 })],
  ]);
}
...
export function decodeReserve<TAddress extends string = string>(
  ...
  return decodeAccount(encodedAccount as MaybeEncodedAccount<TAddress>, getReserveDecoder());
}
