...
export function getUpdateConfigModeCodec(): FixedSizeCodec<UpdateConfigModeArgs, UpdateConfigMode> {
  return combineCodec(getUpdateConfigModeEncoder(), getUpdateConfigModeDecoder());
}
