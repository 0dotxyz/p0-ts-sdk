...
export type ReserveLiquidityArgs = {
  ...
  supplyVault: Address;
  feeVault: Address;
  totalAvailableAmount: number | bigint;
...
export function getReserveLiquidityEncoder(): FixedSizeEncoder<ReserveLiquidityArgs> {
  return getStructEncoder([
    ...
    ["totalAvailableAmount", getU64Encoder()],
    ...
    ["padding2", getArrayEncoder(getU64Encoder(), { size: 50 })],
...
export function getReserveLiquidityDecoder(): FixedSizeDecoder<ReserveLiquidity> {
  return getStructDecoder([
    ...
    ["totalAvailableAmount", getU64Decoder()],
    ...
    ["padding2", getArrayDecoder(getU64Decoder(), { size: 50 })],
    ["padding3", getArrayDecoder(getU128Decoder(), { size: 32 })],
  ]);
}

export function getReserveLiquidityCodec(): FixedSizeCodec<ReserveLiquidityArgs, ReserveLiquidity> {
  return combineCodec(getReserveLiquidityEncoder(), getReserveLiquidityDecoder());
}
