...
export const LENDING_POOL_ADD_BANK_JUPLEND_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  18, 208, 117, 90, 53, 111, 195, 41,
]);

export function getLendingPoolAddBankJuplendDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(LENDING_POOL_ADD_BANK_JUPLEND_DISCRIMINATOR);
}
...
export type LendingPoolAddBankJuplendInstructionData = {
...
export type LendingPoolAddBankJuplendInstructionDataArgs = {
  oracle: Address;
...
export function getLendingPoolAddBankJuplendInstructionDataEncoder(): FixedSizeEncoder<LendingPoolAddBankJuplendInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: LENDING_POOL_ADD_BANK_JUPLEND_DISCRIMINATOR })
  );
}

export function getLendingPoolAddBankJuplendInstructionDataDecoder(): FixedSizeDecoder<LendingPoolAddBankJuplendInstructionData> {
...
export function getLendingPoolAddBankJuplendInstructionDataCodec(): FixedSizeCodec<
  LendingPoolAddBankJuplendInstructionDataArgs,
  LendingPoolAddBankJuplendInstructionData
> {
  return combineCodec(
    getLendingPoolAddBankJuplendInstructionDataEncoder(),
    getLendingPoolAddBankJuplendInstructionDataDecoder()
  );
}
...
> = {
  ...
  depositLimit: LendingPoolAddBankJuplendInstructionDataArgs["depositLimit"];
  oracleSetup: LendingPoolAddBankJuplendInstructionDataArgs["oracleSetup"];
  riskTier: LendingPoolAddBankJuplendInstructionDataArgs["riskTier"];
  configFlags: LendingPoolAddBankJuplendInstructionDataArgs["configFlags"];
  totalAssetValueInitLimit: LendingPoolAddBankJuplendInstructionDataArgs["totalAssetValueInitLimit"];
  oracleMaxAge: LendingPoolAddBankJuplendInstructionDataArgs["oracleMaxAge"];
  oracleMaxConfidence: LendingPoolAddBankJuplendInstructionDataArgs["oracleMaxConfidence"];
  bankSeed: LendingPoolAddBankJuplendInstructionDataArgs["bankSeed"];
};
...
> {
  ...
  if (!accounts.integrationAcc2.value) {
    accounts.integrationAcc2.value = await findIntegrationAcc2Pda({
      bank: getAddressFromResolvedInstructionAccount("bank", accounts.bank.value),
    });
  }
...
export type ParsedLendingPoolAddBankJuplendInstruction<
  TProgram extends string = typeof MARGINFI_PROGRAM_ADDRESS,
...
> = {
  ...
  accounts: {
    ...
    fTokenMint: TAccountMetas[12];
    /**
     * The bank's fToken vault holds the fTokens received when depositing into JupLend.
     *
     */
    integrationAcc2: TAccountMetas[13];
    /**
     * Token program for both underlying mint and fToken mint (SPL Token or Token-2022).
     * JupLend creates fToken mints using the same token program as the underlying.
     */
...
export function parseLendingPoolAddBankJuplendInstruction<
