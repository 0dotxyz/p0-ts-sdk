...
export const LENDING_ACCOUNT_DEPOSIT_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  171, 94, 235, 103, 82, 64, 212, 140,
]);

export function getLendingAccountDepositDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(LENDING_ACCOUNT_DEPOSIT_DISCRIMINATOR);
}

export type LendingAccountDepositInstruction<
...
export function getLendingAccountDepositInstructionDataEncoder(): Encoder<LendingAccountDepositInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ["discriminator", fixEncoderSize(getBytesEncoder(), 8)],
      ["amount", getU64Encoder()],
      ["depositUpToLimit", getOptionEncoder(getBooleanEncoder())],
    ]),
    (value) => ({ ...value, discriminator: LENDING_ACCOUNT_DEPOSIT_DISCRIMINATOR })
  );
}

export function getLendingAccountDepositInstructionDataDecoder(): Decoder<LendingAccountDepositInstructionData> {
  return getStructDecoder([
    ["discriminator", fixDecoderSize(getBytesDecoder(), 8)],
    ["amount", getU64Decoder()],
    ["depositUpToLimit", getOptionDecoder(getBooleanDecoder())],
  ]);
}

export function getLendingAccountDepositInstructionDataCodec(): Codec<
  LendingAccountDepositInstructionDataArgs,
  LendingAccountDepositInstructionData
> {
  return combineCodec(
    getLendingAccountDepositInstructionDataEncoder(),
    getLendingAccountDepositInstructionDataDecoder()
  );
}

export type LendingAccountDepositInput<
...
> = {
  ...
  amount: LendingAccountDepositInstructionDataArgs["amount"];
  depositUpToLimit: LendingAccountDepositInstructionDataArgs["depositUpToLimit"];
};

export function getLendingAccountDepositInstruction<
...
): LendingAccountDepositInstruction<
  TProgramAddress,
...
> {
  ...
  return Object.freeze({
    ...
    data: getLendingAccountDepositInstructionDataEncoder().encode(
      args as LendingAccountDepositInstructionDataArgs
    ),
    programAddress,
  } as LendingAccountDepositInstruction<
    TProgramAddress,
    ResolvedInstructionAccountMeta<TAccountGroup, InstructionAccountInputAddress<TAccountGroup>>,
    ResolvedInstructionAccountMeta<
      TAccountMarginfiAccount,
...
export type ParsedLendingAccountDepositInstruction<
  TProgram extends string = typeof MARGINFI_PROGRAM_ADDRESS,
...
> = {
  ...
  data: LendingAccountDepositInstructionData;
};

export function parseLendingAccountDepositInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedLendingAccountDepositInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getLendingAccountDepositInstructionDataDecoder().decode(instruction.data),
  };
}
