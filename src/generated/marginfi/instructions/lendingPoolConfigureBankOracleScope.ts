...
export const LENDING_POOL_CONFIGURE_BANK_ORACLE_SCOPE_DISCRIMINATOR: ReadonlyUint8Array =
  new Uint8Array([134, 228, 127, 3, 117, 132, 85, 146]);

export function getLendingPoolConfigureBankOracleScopeDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(
    LENDING_POOL_CONFIGURE_BANK_ORACLE_SCOPE_DISCRIMINATOR
  );
}
...
export type LendingPoolConfigureBankOracleScopeInstructionData = {
  discriminator: ReadonlyUint8Array;
  oracle: Address;
  entryIndex: number;
};

export type LendingPoolConfigureBankOracleScopeInstructionDataArgs = {
  oracle: Address;
  entryIndex: number;
};

export function getLendingPoolConfigureBankOracleScopeInstructionDataEncoder(): FixedSizeEncoder<LendingPoolConfigureBankOracleScopeInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ["discriminator", fixEncoderSize(getBytesEncoder(), 8)],
      ["oracle", getAddressEncoder()],
      ["entryIndex", getU16Encoder()],
    ]),
    (value) => ({ ...value, discriminator: LENDING_POOL_CONFIGURE_BANK_ORACLE_SCOPE_DISCRIMINATOR })
  );
}

export function getLendingPoolConfigureBankOracleScopeInstructionDataDecoder(): FixedSizeDecoder<LendingPoolConfigureBankOracleScopeInstructionData> {
  return getStructDecoder([
    ["discriminator", fixDecoderSize(getBytesDecoder(), 8)],
    ["oracle", getAddressDecoder()],
    ["entryIndex", getU16Decoder()],
  ]);
}

export function getLendingPoolConfigureBankOracleScopeInstructionDataCodec(): FixedSizeCodec<
  LendingPoolConfigureBankOracleScopeInstructionDataArgs,
  LendingPoolConfigureBankOracleScopeInstructionData
> {
  return combineCodec(
    getLendingPoolConfigureBankOracleScopeInstructionDataEncoder(),
    getLendingPoolConfigureBankOracleScopeInstructionDataDecoder()
  );
}
...
export type ParsedLendingPoolConfigureBankOracleScopeInstruction<
  TProgram extends string = typeof MARGINFI_PROGRAM_ADDRESS,
...
export function parseLendingPoolConfigureBankOracleScopeInstruction<
