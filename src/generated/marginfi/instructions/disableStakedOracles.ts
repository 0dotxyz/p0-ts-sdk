...
export const DISABLE_STAKED_ORACLES_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  43, 90, 152, 55, 66, 101, 232, 200,
]);

export function getDisableStakedOraclesDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(DISABLE_STAKED_ORACLES_DISCRIMINATOR);
}
...
export type DisableStakedOraclesInstructionData = { discriminator: ReadonlyUint8Array };

export type DisableStakedOraclesInstructionDataArgs = {};

export function getDisableStakedOraclesInstructionDataEncoder(): FixedSizeEncoder<DisableStakedOraclesInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([["discriminator", fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({ ...value, discriminator: DISABLE_STAKED_ORACLES_DISCRIMINATOR })
  );
}

export function getDisableStakedOraclesInstructionDataDecoder(): FixedSizeDecoder<DisableStakedOraclesInstructionData> {
  return getStructDecoder([["discriminator", fixDecoderSize(getBytesDecoder(), 8)]]);
}

export function getDisableStakedOraclesInstructionDataCodec(): FixedSizeCodec<
  DisableStakedOraclesInstructionDataArgs,
  DisableStakedOraclesInstructionData
> {
  return combineCodec(
    getDisableStakedOraclesInstructionDataEncoder(),
    getDisableStakedOraclesInstructionDataDecoder()
  );
}
...
export type ParsedDisableStakedOraclesInstruction<
  TProgram extends string = typeof MARGINFI_PROGRAM_ADDRESS,
...
export function parseDisableStakedOraclesInstruction<
