...
export const LENDING_ACCOUNT_CLOSE_BALANCE_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  245, 54, 41, 4, 243, 202, 31, 17,
]);

export function getLendingAccountCloseBalanceDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(LENDING_ACCOUNT_CLOSE_BALANCE_DISCRIMINATOR);
}

export type LendingAccountCloseBalanceInstruction<
...
export type LendingAccountCloseBalanceInstructionData = { discriminator: ReadonlyUint8Array };

export type LendingAccountCloseBalanceInstructionDataArgs = {};

export function getLendingAccountCloseBalanceInstructionDataEncoder(): FixedSizeEncoder<LendingAccountCloseBalanceInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([["discriminator", fixEncoderSize(getBytesEncoder(), 8)]]),
    (value) => ({ ...value, discriminator: LENDING_ACCOUNT_CLOSE_BALANCE_DISCRIMINATOR })
  );
}

export function getLendingAccountCloseBalanceInstructionDataDecoder(): FixedSizeDecoder<LendingAccountCloseBalanceInstructionData> {
  return getStructDecoder([["discriminator", fixDecoderSize(getBytesDecoder(), 8)]]);
}

export function getLendingAccountCloseBalanceInstructionDataCodec(): FixedSizeCodec<
  LendingAccountCloseBalanceInstructionDataArgs,
  LendingAccountCloseBalanceInstructionData
> {
  return combineCodec(
    getLendingAccountCloseBalanceInstructionDataEncoder(),
    getLendingAccountCloseBalanceInstructionDataDecoder()
  );
}

export type LendingAccountCloseBalanceInput<
...
export function getLendingAccountCloseBalanceInstruction<
...
): LendingAccountCloseBalanceInstruction<
  TProgramAddress,
...
> {
  ...
  return Object.freeze({
    ...
    data: getLendingAccountCloseBalanceInstructionDataEncoder().encode({}),
    programAddress,
  } as LendingAccountCloseBalanceInstruction<
    TProgramAddress,
    ResolvedInstructionAccountMeta<TAccountGroup, InstructionAccountInputAddress<TAccountGroup>>,
    ResolvedInstructionAccountMeta<
      TAccountMarginfiAccount,
...
export type ParsedLendingAccountCloseBalanceInstruction<
  TProgram extends string = typeof MARGINFI_PROGRAM_ADDRESS,
...
> = {
  ...
  data: LendingAccountCloseBalanceInstructionData;
};

export function parseLendingAccountCloseBalanceInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedLendingAccountCloseBalanceInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getLendingAccountCloseBalanceInstructionDataDecoder().decode(instruction.data),
  };
}
