...
export function getLendingPoolConfigureBankDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(LENDING_POOL_CONFIGURE_BANK_DISCRIMINATOR);
}

export type LendingPoolConfigureBankInstruction<
...
export function getLendingPoolConfigureBankInstructionDataCodec(): Codec<
  LendingPoolConfigureBankInstructionDataArgs,
  LendingPoolConfigureBankInstructionData
> {
  return combineCodec(
    getLendingPoolConfigureBankInstructionDataEncoder(),
    getLendingPoolConfigureBankInstructionDataDecoder()
  );
}

export type LendingPoolConfigureBankInput<
...
> {
  ...
  return Object.freeze({
    ...
    programAddress,
  } as LendingPoolConfigureBankInstruction<
    TProgramAddress,
    ResolvedInstructionAccountMeta<TAccountGroup, InstructionAccountInputAddress<TAccountGroup>>,
    ResolvedInstructionAccountMeta<TAccountAdmin, InstructionAccountInputAddress<TAccountAdmin>>,
    ResolvedInstructionAccountMeta<TAccountBank, InstructionAccountInputAddress<TAccountBank>>
...
export type ParsedLendingPoolConfigureBankInstruction<
  TProgram extends string = typeof MARGINFI_PROGRAM_ADDRESS,
...
export function parseLendingPoolConfigureBankInstruction<
