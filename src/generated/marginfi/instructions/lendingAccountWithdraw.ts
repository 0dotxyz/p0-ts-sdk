...
export const LENDING_ACCOUNT_WITHDRAW_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  36, 72, 74, 19, 210, 210, 192, 192,
]);

export function getLendingAccountWithdrawDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(LENDING_ACCOUNT_WITHDRAW_DISCRIMINATOR);
}

export type LendingAccountWithdrawInstruction<
...
export function getLendingAccountWithdrawInstructionDataEncoder(): Encoder<LendingAccountWithdrawInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: LENDING_ACCOUNT_WITHDRAW_DISCRIMINATOR })
  );
}

export function getLendingAccountWithdrawInstructionDataDecoder(): Decoder<LendingAccountWithdrawInstructionData> {
...
export function getLendingAccountWithdrawInstructionDataCodec(): Codec<
  LendingAccountWithdrawInstructionDataArgs,
  LendingAccountWithdrawInstructionData
> {
  return combineCodec(
    getLendingAccountWithdrawInstructionDataEncoder(),
    getLendingAccountWithdrawInstructionDataDecoder()
  );
}

export type LendingAccountWithdrawAsyncInput<
...
> = {
  ...
  amount: LendingAccountWithdrawInstructionDataArgs["amount"];
  withdrawAll: LendingAccountWithdrawInstructionDataArgs["withdrawAll"];
};

export async function getLendingAccountWithdrawInstructionAsync<
...
>(
  ...
  LendingAccountWithdrawInstruction<
    TProgramAddress,
...
> {
  ...
  if (!accounts.bankLiquidityVaultAuthority.value) {
    accounts.bankLiquidityVaultAuthority.value = await findLiquidityVaultAuthorityPda(
  ...
  return Object.freeze({
    ...
    data: getLendingAccountWithdrawInstructionDataEncoder().encode(
      args as LendingAccountWithdrawInstructionDataArgs
    ),
    programAddress,
  } as LendingAccountWithdrawInstruction<
    TProgramAddress,
    ResolvedInstructionAccountMeta<TAccountGroup, InstructionAccountInputAddress<TAccountGroup>>,
    ResolvedInstructionAccountMeta<
      TAccountMarginfiAccount,
...
export type LendingAccountWithdrawInput<
  TAccountGroup extends InstructionAccountInput = InstructionAccountInput,
  TAccountMarginfiAccount extends InstructionAccountInput = InstructionAccountInput,
  TAccountAuthority extends InstructionSignerInput = InstructionSignerInput,
  TAccountBank extends InstructionAccountInput = InstructionAccountInput,
...
export function getLendingAccountWithdrawInstruction<
  TAccountGroup extends InstructionAccountInput,
  TAccountMarginfiAccount extends InstructionAccountInput,
  TAccountAuthority extends InstructionSignerInput,
  TAccountBank extends InstructionAccountInput,
  ...
  TProgramAddress extends Address = typeof MARGINFI_PROGRAM_ADDRESS,
>(
  input: LendingAccountWithdrawInput<
    TAccountGroup,
    TAccountMarginfiAccount,
    TAccountAuthority,
    TAccountBank,
...
export type ParsedLendingAccountWithdrawInstruction<
  TProgram extends string = typeof MARGINFI_PROGRAM_ADDRESS,
...
> = {
  ...
  accounts: {
    ...
    bankLiquidityVaultAuthority: TAccountMetas[5];
    liquidityVault: TAccountMetas[6];
    tokenProgram: TAccountMetas[7];
  };
  data: LendingAccountWithdrawInstructionData;
};

export function parseLendingAccountWithdrawInstruction<
...
>(
  instruction: Instruction<TProgram> &
    ...
    InstructionWithData<ReadonlyUint8Array>
): ParsedLendingAccountWithdrawInstruction<TProgram, TAccountMetas> {
  ...
  return {
    ...
    data: getLendingAccountWithdrawInstructionDataDecoder().decode(instruction.data),
  };
}
