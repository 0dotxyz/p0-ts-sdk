...
export const SUPER_ADMIN_DEPOSIT_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  241, 189, 199, 17, 207, 225, 64, 75,
]);

export function getSuperAdminDepositDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(SUPER_ADMIN_DEPOSIT_DISCRIMINATOR);
}

export type SuperAdminDepositInstruction<
...
export type SuperAdminDepositInstructionData = {
  discriminator: ReadonlyUint8Array;
  amount: bigint;
};

export type SuperAdminDepositInstructionDataArgs = { amount: number | bigint };

export function getSuperAdminDepositInstructionDataEncoder(): FixedSizeEncoder<SuperAdminDepositInstructionDataArgs> {
  return transformEncoder(
    getStructEncoder([
      ["discriminator", fixEncoderSize(getBytesEncoder(), 8)],
      ["amount", getU64Encoder()],
    ]),
    (value) => ({ ...value, discriminator: SUPER_ADMIN_DEPOSIT_DISCRIMINATOR })
  );
}

export function getSuperAdminDepositInstructionDataDecoder(): FixedSizeDecoder<SuperAdminDepositInstructionData> {
...
export function getSuperAdminDepositInstructionDataCodec(): FixedSizeCodec<
  SuperAdminDepositInstructionDataArgs,
  SuperAdminDepositInstructionData
> {
  return combineCodec(
    getSuperAdminDepositInstructionDataEncoder(),
    getSuperAdminDepositInstructionDataDecoder()
  );
}

export type SuperAdminDepositInput<
...
export function getSuperAdminDepositInstruction<
...
> {
  ...
  return Object.freeze({
    ...
    programAddress,
  } as SuperAdminDepositInstruction<
    TProgramAddress,
    ResolvedInstructionAccountMeta<TAccountGroup, InstructionAccountInputAddress<TAccountGroup>>,
    ResolvedInstructionAccountMeta<TAccountAdmin, InstructionAccountInputAddress<TAccountAdmin>>,
    ResolvedInstructionAccountMeta<TAccountBank, InstructionAccountInputAddress<TAccountBank>>,
...
export type ParsedSuperAdminDepositInstruction<
  TProgram extends string = typeof MARGINFI_PROGRAM_ADDRESS,
...
export function parseSuperAdminDepositInstruction<
