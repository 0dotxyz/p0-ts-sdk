...
export const REFRESH_USER_STATE_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  1, 135, 12, 62, 243, 140, 77, 108,
]);

export function getRefreshUserStateDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(REFRESH_USER_STATE_DISCRIMINATOR);
}
...
export type RefreshUserStateInstructionData = { discriminator: ReadonlyUint8Array };
...
>(
  input: RefreshUserStateInput<TAccountUserState, TAccountFarmState, TAccountScopePrices>,
