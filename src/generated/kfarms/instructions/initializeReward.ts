...
export const INITIALIZE_REWARD_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  95, 135, 192, 196, 242, 129, 230, 68,
]);

export function getInitializeRewardDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(INITIALIZE_REWARD_DISCRIMINATOR);
}
...
export type InitializeRewardInstructionData = { discriminator: ReadonlyUint8Array };
...
> {
  ...
  const originalAccounts = {
    ...
    rewardVault: { value: input.rewardVault ?? null, isSigner: false, isWritable: true },
    rewardTreasuryVault: {
