...
> {
  return combineCodec(getAddRewardsInstructionDataEncoder(), getAddRewardsInstructionDataDecoder());
}
...
export type AddRewardsInput<
  ...
  TAccountPayerRewardTokenAta extends InstructionAccountInput = InstructionAccountInput,
...
> = {
  ...
  payerRewardTokenAta: TAccountPayerRewardTokenAta;
...
export function getAddRewardsInstruction<
  ...
  TAccountPayerRewardTokenAta extends InstructionAccountInput,
...
>(
  ...
  ResolvedInstructionAccountMeta<
    TAccountPayerRewardTokenAta,
    InstructionAccountInputAddress<TAccountPayerRewardTokenAta>
  >,
  ResolvedInstructionAccountMeta<
    TAccountScopePrices,
...
> {
  ...
  return Object.freeze({
    ...
    data: getAddRewardsInstructionDataEncoder().encode(args as AddRewardsInstructionDataArgs),
    programAddress,
