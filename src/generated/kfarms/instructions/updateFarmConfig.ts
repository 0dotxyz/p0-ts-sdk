...
export const UPDATE_FARM_CONFIG_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  214, 176, 188, 244, 203, 59, 230, 207,
]);

export function getUpdateFarmConfigDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(UPDATE_FARM_CONFIG_DISCRIMINATOR);
}
...
export type UpdateFarmConfigInstructionDataArgs = { mode: number; data: ReadonlyUint8Array };
...
>(
  input: UpdateFarmConfigInput<TAccountSigner, TAccountFarmState, TAccountScopePrices>,
