...
export type UpdateGlobalConfigAdminInput<
  TAccountPendingGlobalAdmin extends InstructionSignerInput = InstructionSignerInput,
  TAccountGlobalConfig extends InstructionAccountInput = InstructionAccountInput,
> = {
  pendingGlobalAdmin: TAccountPendingGlobalAdmin;
  globalConfig: TAccountGlobalConfig;
};

export function getUpdateGlobalConfigAdminInstruction<
  TAccountPendingGlobalAdmin extends InstructionSignerInput,
  TAccountGlobalConfig extends InstructionAccountInput,
  TProgramAddress extends Address = typeof FARMS_PROGRAM_ADDRESS,
>(
  input: UpdateGlobalConfigAdminInput<TAccountPendingGlobalAdmin, TAccountGlobalConfig>,
  config?: { programAddress?: TProgramAddress }
): UpdateGlobalConfigAdminInstruction<
  TProgramAddress,
  ResolvedInstructionAccountMeta<
    TAccountPendingGlobalAdmin,
    InstructionAccountInputAddress<TAccountPendingGlobalAdmin>
  >,
  ResolvedInstructionAccountMeta<
    TAccountGlobalConfig,
...
>(
  ...
  return {
    ...
    accounts: { pendingGlobalAdmin: getNextAccount(), globalConfig: getNextAccount() },
