...
export const REWARD_USER_ONCE_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  219, 137, 57, 22, 94, 186, 96, 114,
]);

export function getRewardUserOnceDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(REWARD_USER_ONCE_DISCRIMINATOR);
}
...
>(
  input: RewardUserOnceInput<TAccountDelegateAuthority, TAccountFarmState, TAccountUserState>,
...
> {
  ...
  const originalAccounts = {
    delegateAuthority: { value: input.delegateAuthority ?? null, isSigner: true, isWritable: true },
