...
export const DEPOSIT_TO_FARM_VAULT_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  131, 166, 64, 94, 108, 213, 114, 183,
]);

export function getDepositToFarmVaultDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(DEPOSIT_TO_FARM_VAULT_DISCRIMINATOR);
}
...
export function getDepositToFarmVaultInstructionDataEncoder(): FixedSizeEncoder<DepositToFarmVaultInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: DEPOSIT_TO_FARM_VAULT_DISCRIMINATOR })
  );
}
...
export type DepositToFarmVaultInput<
  ...
  TAccountDepositorAta extends InstructionAccountInput = InstructionAccountInput,
...
> = {
  ...
  depositorAta: TAccountDepositorAta;
...
export function getDepositToFarmVaultInstruction<
  ...
  TAccountDepositorAta extends InstructionAccountInput,
...
>(
  ...
  ResolvedInstructionAccountMeta<
    TAccountDepositorAta,
    InstructionAccountInputAddress<TAccountDepositorAta>
  >,
  ResolvedInstructionAccountMeta<
    TAccountTokenProgram,
...
> {
  ...
  const originalAccounts = {
    depositor: { value: input.depositor ?? null, isSigner: true, isWritable: false },
    ...
    depositorAta: { value: input.depositorAta ?? null, isSigner: false, isWritable: true },
...
>(
  ...
  return {
    ...
    data: getDepositToFarmVaultInstructionDataDecoder().decode(instruction.data),
  };
}
