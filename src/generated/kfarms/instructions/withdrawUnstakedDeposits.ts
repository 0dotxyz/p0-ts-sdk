...
export const WITHDRAW_UNSTAKED_DEPOSITS_DISCRIMINATOR: ReadonlyUint8Array = new Uint8Array([
  36, 102, 187, 49, 220, 36, 132, 67,
]);

export function getWithdrawUnstakedDepositsDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(WITHDRAW_UNSTAKED_DEPOSITS_DISCRIMINATOR);
}
...
export type WithdrawUnstakedDepositsInstructionData = { discriminator: ReadonlyUint8Array };
...
export function getWithdrawUnstakedDepositsInstructionDataEncoder(): FixedSizeEncoder<WithdrawUnstakedDepositsInstructionDataArgs> {
  return transformEncoder(
    ...
    (value) => ({ ...value, discriminator: WITHDRAW_UNSTAKED_DEPOSITS_DISCRIMINATOR })
  );
}
