...
export function getHarvestRewardDiscriminatorBytes(): ReadonlyUint8Array {
  return fixEncoderSize(getBytesEncoder(), 8).encode(HARVEST_REWARD_DISCRIMINATOR);
}
...
export type HarvestRewardInput<
  ...
  TAccountUserRewardTokenAccount extends InstructionAccountInput = InstructionAccountInput,
...
> = {
  ...
  userRewardTokenAccount: TAccountUserRewardTokenAccount;
...
export function getHarvestRewardInstruction<
  ...
  TAccountUserRewardTokenAccount extends InstructionAccountInput,
...
>(
  ...
  ResolvedInstructionAccountMeta<
    TAccountUserRewardTokenAccount,
    InstructionAccountInputAddress<TAccountUserRewardTokenAccount>
  >,
  ResolvedInstructionAccountMeta<
    TAccountRewardsVault,
...
> {
  ...
  return Object.freeze({
    ...
    data: getHarvestRewardInstructionDataEncoder().encode(args as HarvestRewardInstructionDataArgs),
    programAddress,
