...
export function getFarmConfigOptionCodec(): FixedSizeCodec<FarmConfigOptionArgs, FarmConfigOption> {
  return combineCodec(getFarmConfigOptionEncoder(), getFarmConfigOptionDecoder());
}
