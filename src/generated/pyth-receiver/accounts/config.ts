...
export type ConfigArgs = {
  governanceAuthority: Address;
  targetGovernanceAuthority: OptionOrNullable<Address>;
  wormhole: Address;
  validDataSources: Array<DataSourceArgs>;
  singleUpdateFeeInLamports: number | bigint;
  minimumSignatures: number;
};
...
export function getConfigEncoder(): Encoder<ConfigArgs> {
  return transformEncoder(
    getStructEncoder([
      ...
      ["targetGovernanceAuthority", getOptionEncoder(getAddressEncoder())],
...
export function getConfigDecoder(): Decoder<Config> {
  return getStructDecoder([
    ...
    ["targetGovernanceAuthority", getOptionDecoder(getAddressDecoder())],
